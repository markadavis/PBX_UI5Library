sap.ui.define([
	 ...
	 *
	 * @class Item that represents one file to be uploaded using the {@link com.publix.ui5library.ca.uploader.UploadSet} control.
	 * 
	 ...
	 * @constructor
	 * @public
	 * @alias com.publix.ui5library.ca.uploader.UploadSetItem
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel.
	 */
	var UploadSetItem = Element.extend("com.publix.ui5library.ca.uploader.UploadSetItem", {
		metadata: {
			...
			properties: {
				 ...
				 */
				uploadState: {type: "com.publix.ui5library.UploadState", defaultValue: null},
				/**
				 * Specifies the URL where the file is located.
				 * <br>If the application doesn't provide a value for this property, the icon and
				 * the file name are not clickable in {@link com.publix.ui5library.ca.uploader.UploadSet}.
				 */
	...
	var DynamicItemContent = HTML.extend("com.publix.ui5library.ca.uploader.DynamicItemContent", {
		metadata: {
			properties: {
				item: {type: "com.publix.ui5library.ca.uploader.UploadSetItem"}
			}
