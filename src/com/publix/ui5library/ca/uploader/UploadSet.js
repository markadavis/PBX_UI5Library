sap.ui.define([
	...
	"com/publix/ui5library/ca/uploader/utilities/deepEqual",
	"com/publix/ui5library/ca/uploader/utilities/KeyCodes",
	"com/publix/ui5library/ca/uploader/Uploader",
	"com/publix/ui5library/ca/uploader/UploadSetItem",
	"com/publix/ui5library/ca/uploader/UploadSetRenderer"
	 ...
	 * @constructor
	 * @public
	 * @alias com.publix.ui5library.ca.uploader.UploadSet
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel.
	 */
	var UploadSet = Control.extend("com.publix.ui5library.ca.uploader.UploadSet", {
		metadata: {
			library: "com.publix.ui5library",
			properties: {
				/**
			...
			aggregations: {
				 ...
				 */
				items: {type: "com.publix.ui5library.ca.uploader.UploadSetItem", multiple: true, singularName: "item"},
				/**
				 * Items representing files yet to be uploaded.
				 */
				incompleteItems: {type: "com.publix.ui5library.ca.uploader.UploadSetItem", multiple: true, singularName: "incompleteItem"},
				/**
				 ...
				 */
				uploader: {type: "com.publix.ui5library.ca.uploader.Uploader", multiple: false}
			},
			events: {
				/**
				...
				beforeItemAdded: {
					parameters: {
						 ...
						 */
						item: {type: "com.publix.ui5library.ca.uploader.UploadSetItem"}
					},
				...
				selectionChanged: {
					parameters: {
						 ...
						 */
						items: {type: "com.publix.ui5library.ca.uploader.UploadSetItem[]"}
					}
				}
			}
		},
	...
	UploadSet.prototype.init = function () {
		this._oRb = sap.ui.getCore().getLibraryResourceBundle("com.publix.ui5library");
	 ...
	 * @param {Uploader} oUploader Instance of <code>com.publix.ui5library.ca.uploader.Uploader</code> to which the default request handlers are attached.
	 * @public
	 */
