sap.ui.define([
	...
	return UI5Object.extend("com.publix.ui5library.wm.warehouseSelector.WarehouseSelector", {
		/**
		 * Construct a dialog to choose a Warehouse based on filter criteria.
		 * @class
		 * @alias com.publix.ui5library.wm.warehouseSelector.WarehouseSelector
		 * @public
		...
		constructor: function(fnCallBack, oComponent, bUseDefault) {
			...
			this._oResourceModel = new ResourceModel({
				bundleName: "com.publix.ui5library.wm.warehouseSelector.WarehouseSelector"
			});
		...
		onChangeWarehouse: function(fnCallBack) {
			...
			this._oChgWhseDialog = new sap.ui.xmlfragment("com.publix.ui5library.wm.warehouseSelector.WarehouseSelector", this);
