sap.ui.define([
	...
	return UI5Object.extend("com.publix.zUI5Library.wm.warehouseSelector.WarehouseSelector", {
		/**
		 * Construct a dialog to choose a Warehouse based on filter criteria.
		 * @class
		 * @alias com.publix.zUI5Library.wm.warehouseSelector.WarehouseSelector
		 * @public
		...
		constructor: function(fnCallBack, oComponent, bUseDefault) {
			...
			this._oResourceModel = new ResourceModel({
				bundleName: "com.publix.zUI5Library.wm.warehouseSelector.WarehouseSelector"
			});
		...
		onChangeWarehouse: function(fnCallBack) {
			...
			this._oChgWhseDialog = new sap.ui.xmlfragment("com.publix.zUI5Library.wm.warehouseSelector.WarehouseSelector", this);
		 ...
		 */
		 getDefaultWarehouse: function(fnCallback) {
			this._oODataModel.callFunction("/printLabel", {
				method: "GET",
