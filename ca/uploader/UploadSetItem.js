sap.ui.define([
	...
	"sap/m/VBox",
	"sap/m/HBox"
], function (CoreLibrary, Element, Icon, IconPool, HTML, FileUtil, MobileLibrary, PublixLibrary, BusyIndicator,
			Button, CustomListItem, Image, Input, Label, Link, ProgressIndicator, VBox, HBox) {
	"use strict";

	/**
	 * Constructor for a new UploadSetItem.
	 *
	 * @class Item that represents one file to be uploaded using the {@link com.publix.zUI5Library.ca.uploader.UploadSet} control.
	 * 
	 ...
	 * @constructor
	 * @public
	 * @alias com.publix.zUI5Library.ca.uploader.UploadSetItem
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel.
	 */
	var UploadSetItem = Element.extend("com.publix.zUI5Library.ca.uploader.UploadSetItem", {
		metadata: {
			...
			properties: {
				 ...
				 */
				uploadState: {type: "com.publix.zUI5Library.UploadState", defaultValue: null},
				/**
				 * Specifies the URL where the file is located.
				 * <br>If the application doesn't provide a value for this property, the icon and
				 * the file name are not clickable in {@link com.publix.zUI5Library.ca.uploader.UploadSet}.
				 */
	...
	var DynamicItemContent = HTML.extend("com.publix.zUI5Library.ca.uploader.DynamicItemContent", {
		metadata: {
			properties: {
				item: {type: "com.publix.zUI5Library.ca.uploader.UploadSetItem"}
			}
	...
	UploadSetItem.prototype.getDeleteButton = function() {
	...
	UploadSetItem.prototype.download = function (bAskForLocation) {
		...
		if (!oParent) {
			jQuery.sap.log.warning("Download cannot proceed without a parent association.");
			return false;
		}
